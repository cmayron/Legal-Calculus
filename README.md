...
Domain‑Specific Editions in This Repository

The Legal Calculus Educational System includes multiple domain‑specific editions.  
Each edition applies the Six Calculi to a specific court environment, providing  
tailored workflows, field guides, and procedural structures.
...
Each edition is built on the Six Calculi, activated through the Startup Block,  
and compatible with Deep Research.
---
